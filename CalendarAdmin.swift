...
struct CalendarAdmin: View {
    @StateObject var taskModel: TaskViewModelAdmin = TaskViewModelAdmin()
                        ...
                        HStack(spacing: 10){
                            ...
                            ForEach(taskModel.currentWeek, id:\.self){ day in
                                ...
                                VStack(spacing: 10){
                                    ...
                                    // EEE will return date as MON, TUE
    ...
    func TasksView()-> some View{
        ...
        .padding(.top)
        // MARK: Updating Tasks
        .onChange(of: taskModel.currentDay  ){ newValue in taskModel.filterTodayTasks()
        }
    }
    // MARK: Task Card View
